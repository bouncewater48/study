...
--VALUES(SEQ_USER.NEXTVAL,'abc', 'abc123', '신짱구', 5, to_date('2021-07-01','yyyy-mm-dd'));
VALUES(SEQ_USER.NEXTVAL, 'test', '1234', '유리', 5, TO_DATE)

SELECT USER_NUMBER FROM TBL_USER WHERE USER_ID = 'abc';
