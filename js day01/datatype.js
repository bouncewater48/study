...
console.log(Boolean(" "), typeof Boolean(" ")); //띄워쓰기도 값이므로 true
...
// Falsy와 Truthy : 특정 값들이 논리적 평가(조건문)에서 어떻게 처리되는지를 설명하는 개념
// Falsy는 false처럼 동작하고 Truthy는 true처럼 동작하는 값
...
// Object
// 객체 : 키-값 쌍의 집합
let person = {name : "강승훈", age : 27, isStudent : true};
