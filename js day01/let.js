...
// var에서는 호이스팅이 가능하나, let에서는 호이스팅이 불가하다(호이스팅은 var.js 참고)
...
// 초기화 전에 접근하려고 하면 참조에러(Reference Error)가 발생한다
// 그 이유는 let, const는 선언이 코드의 실행 흐름에 도달했을 때 초기화 되기 때문이다
// ReferenceError: Cannot access 'number1' before initialization 접근불가 참조에러