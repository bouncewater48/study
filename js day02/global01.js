...
console.log(globalThis.str); // 글로벌 객체 str에 값 변경으로 변경됨 => 전역객체에 변수를 설정할 수 있고 함수 밖에서도 접근 가능
console.log(globalThis.number); //undefined 블록스코프 변수이므로 globalThis.number로 설정 안됨, number로 출력시 오류발생
